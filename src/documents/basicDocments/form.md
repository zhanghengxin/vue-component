    ...
    <div class="example-box">
        ...
        <b-form ref="form" :model="form" :label-width="80">
          ...
          <b-form-item label="活动性质">
            ...
            <b-button @on-click="onSubmit">提交</b-button>
            <b-button @on-click="onClick">取消</b-button>
        </b-form>
        </div>
    </div>
...
<div class="example">
    <div class="example-box">
        <div>
       <b-form inline :model="form" :label-width="60" label-position="left">
         <b-form-item label="姓名">
           <b-input v-model="form.name" placeholder="姓名"></b-input>
         </b-form-item>
          <b-form-item label="生活">
             <b-input v-model="form.life" placeholder="生活"></b-input>
           </b-form-item>
           <b-button @on-click="onSubmit">查询</b-button>
       </b-form>
        </div>
    </div>
...
<div class="example">
    <div class="example-box">
        <div>
      <b-form :model="formValidate" :rules="ruleValidate" :label-width="80" ref="formValidate">
         <b-form-item label="姓名" prop="name">
           <b-input v-model="formValidate.name" placeholder="请输入姓名"></b-input>
         </b-form-item>
         <b-form-item label="邮箱" prop="email">
           <b-input v-model="formValidate.email" placeholder="请输入邮箱"></b-input>
         </b-form-item>
         <b-form-item label="兴趣" prop="hobby">
           <b-checkboxGroup v-model="formValidate.hobby">
             <b-checkbox label="唱歌"></b-checkbox>
             <b-checkbox label="跳舞"></b-checkbox>
             <b-checkbox label="打游戏"></b-checkbox>
             <b-checkbox label="看电影"></b-checkbox>
           </b-checkboxGroup>
         </b-form-item>
         <b-form-item label="描述" prop="desc">
           <b-input v-model="formValidate.desc" placeholder="请输入你的描述" type="textarea"></b-input>
         </b-form-item>
         <b-button @on-click="handleSubmit('formValidate')">提交</b-button>
         <b-button @on-click="handleReset('formValidate')">重置</b-button>
       </b-form>
        </div>
    </div>
